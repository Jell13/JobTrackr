        ...
        <section className="flex justify-center items-center z-10 px-36">
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-0.5">
              <h2 className="text-accent text-lg tracking-wide">
                WELCOME BACK
              </h2>
            ...
            <div className="flex flex-col gap-3">
              <button className="px-12 border py-2 rounded-md btn-primary:hover flex justify-center items-center gap-2">
                <FcGoogle className="w-5 h-5" />
                Continue with Google
              </button>
              <button className="px-12 border py-2 rounded-md bg-[#111827] text-accent-tint btn-primary:hover flex justify-center items-center gap-2">
            ...
            <div className="flex justify-center items-center">
              <button>Continue with email instead</button>
            </div>
            <div>
